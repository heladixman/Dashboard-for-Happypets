...
import { BiColorFill, BiStore, BiScan, BiBox } from 'react-icons/bi';
...
import { GiLouvrePyramid, GiCat, GiSittingDog, GiRabbit, GiHummingbird} from 'react-icons/gi';
...
const areaChartData = [
  [
    ...
    { x: new Date(2014, 0, 1), y: 3.4 },
    { x: new Date(2015, 0, 1), y: 2.8 },
    { x: new Date(2016, 0, 1), y: 1.6 },
    { x: new Date(2017, 0, 1), y: 2.3 },
    { x: new Date(2018, 0, 1), y: 2.5 },
    { x: new Date(2019, 0, 1), y: 2.9 },
    { x: new Date(2020, 0, 1), y: 3.8 },
    { x: new Date(2021, 0, 1), y: 1.4 },
    { x: new Date(2022, 0, 1), y: 3.1 },
  ],
  [
    { x: new Date(2013, 0, 1), y: 2 },
    { x: new Date(2014, 0, 1), y: 1.7 },
    { x: new Date(2015, 0, 1), y: 1.8 },
    { x: new Date(2016, 0, 1), y: 2.1 },
    { x: new Date(2017, 0, 1), y: 2.3 },
    { x: new Date(2018, 0, 1), y: 1.7 },
    { x: new Date(2019, 0, 1), y: 1.5 },
    { x: new Date(2020, 0, 1), y: 2.8 },
    { x: new Date(2021, 0, 1), y: 1.5 },
    { x: new Date(2022, 0, 1), y: 2.3 },
  ],
  [
    { x: new Date(2013, 0, 1), y: 0.8 },
    { x: new Date(2014, 0, 1), y: 1.3 },
    { x: new Date(2015, 0, 1), y: 1.1 },
    { x: new Date(2016, 0, 1), y: 1.6 },
    { x: new Date(2017, 0, 1), y: 2 },
    { x: new Date(2018, 0, 1), y: 1.7 },
    { x: new Date(2019, 0, 1), y: 2.3 },
    { x: new Date(2020, 0, 1), y: 2.7 },
    { x: new Date(2021, 0, 1), y: 1.1 },
    { x: new Date(2022, 0, 1), y: 2.3 },
  ],
];
...
export const barChartData = [
  [
    { x: 'Persentasi Pencarian', y: 26 },
  ],
  [
    { x: 'Persentasi Pencarian', y: 22 },
  ],
  [
    { x: 'Persentasi Pencarian', y: 18 },
  ],
  [
    { x: 'Persentasi Pencarian', y: 12 },
  ],
  [
    { x: 'Persentasi Pencarian', y: 4 },
  ],
  [
    { x: 'Persentasi Pencarian', y: 18 },
  ],
...
export const links = [
  ...
  },
  {
    ...
    links: [
      {
        name: 'Wawasan Penjualan',
        link: 'wawasan-penjualan',
        icon: <AiOutlineStock />,
      },
      {
        name: 'Wawasan Pengguna',
        link: 'wawasan-pengguna',
      ...
      {
        name: 'Wawasan Peliharaan',
        link: 'wawasan-peliharaan',
        icon: <FiPieChart />,
      },
    ],
  },
    ...
    links: [
      {
        ...
        link: 'category/add-new-category',
        icon: <AiOutlineShoppingCart />,
      },
      {
        name: 'categories',
...
export const chatData = [
  {
    image:
      avatar2,
    message: 'Naila Fitria',
    desc: 'Kak, cara setting pengiriman gimana?',
    time: '9:08 AM',
  },
  {
    image:
      avatar3,
    message: 'Farhan Ibas',
    desc: 'Konfirmasi Pesanan #010101 ',
    time: '11:56 AM',
  },
  {
    image:
      avatar4,
    message: 'Rainhard Lubis',
    desc: 'Hela, Mohon Tambah Metode Pengiriman Baru',
    time: '4:39 AM',
  },
  {
    image:
      avatar,
    message: 'Dika Aditya',
    desc: 'Non Aktifkan Toko dengan ID #02292',
    time: '1:12 AM',
  },
];
...
export const notificationData = [
  {
    image:
      avatar2,
    message: 'QRIS',
    desc: 'Pembayaran Pesanan dengan ID #01010 telah Lunas',
    time: '9:08 AM',
  },
  {
    image:
      avatar3,
    message: 'Pesanan #90291',
    desc: 'Novita baru saja membuat pesanan',
    time: '11:56 AM',
  },
  {
    image:
      avatar4,
    message: 'Pesanan #88281',
    desc: 'Pelanggan baru saja membatalkan orderan',
    time: '4:39 AM',
  },
  {
    image:
      avatar,
    message: 'Dika Aditya',
    desc: 'Pesanan dengan ID #87699 baru saja dikirim',
    time: '1:12 AM',
  },
];
...
export const weeklyStats = [
  {
    icon: <BiBox />,
    amount: '-$560',
    title: 'NortoFood Salmon Norwegian Cat Food',
    desc: 'Super Petshop',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
  {
    icon: <BiBox />,
    amount: '-$560',
    title: 'NortoFood Salmon Norwegian Dog Food',
    desc: 'Super Petshop',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
  {
    icon: <BiBox />,
    amount: '+$560',
    title: 'Lalaria Premium Bird Food',
    desc: 'DuniaBurung',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
  ...
  },
  {
    icon: <BiBox />,
    amount: '+$560',
    title: 'Horio Super Premium Dog Food',
    desc: 'DuniaAnjing',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
...
export const productStats = [
  {
    icon: <BiBox />,
    amount: '-$560',
    title: 'NortoFood Blue Dragon Fish Cat Food',
    desc: 'Product',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
  {
    icon: <BiBox />,
    amount: '-$560',
    title: 'Mangkuk Makan Kucing Size XL',
    desc: 'Product',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
  {
    icon: <GiCat />,
    amount: '+$560',
    title: 'Kucing Persia Blaster Jantan',
    desc: 'Pet',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
  {
    icon: <BiBox />,
    amount: '+$560',
    title: 'Kalung Anjing nama pemilik size M',
    desc: 'Product',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
  {
    icon: <GiSittingDog />,
    amount: '+$560',
    title: 'Anak Anjing Buldog Hitam Putih',
    desc: 'Pet',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
...
export const produkGrid = [
  ...
  { field: 'CustomerName',
    headerText: 'Stok Produk',
    width: '150',
    textAlign: 'Center',
  },
  {
    field: 'Location',
    headerText: 'Nama Toko',
    width: '150',
    textAlign: 'Center',
  },
  {
    field: 'TotalAmount',
    headerText: 'Harga Produk',
    // format: 'C2',
    textAlign: 'Center',
    editType: 'numericedit',
    width: '120',
...
export const tokoGrid = [
  ...
  { field: 'CustomerName',
  headerText: 'Alamat Toko',
  width: '150',
  textAlign: 'Center',
  },
  {
    headerText: 'Status Toko',
    template: gridOrderStatus,
    field: 'OrderItems',
    textAlign: 'Center',
    width: '200',
...
export const listProduksData = [
  {
    OrderID: 1,
    CustomerName: 'Makanan Kucing',
    TotalAmount: 1285000,
    OrderItems: 'Fresh Tomato',
    Location: 'Petshop Batam',
    Status: 'Aktif',
    StatusBg: '#8BE78B',
    ProductImage:
      product6,
  ...
  {
    OrderID: 3,
    CustomerName: 'Makanan Ikan Hias',
    TotalAmount: 1285000,
    OrderItems: 'Candy Gucci',
    Location: 'Petshop Batam',
    Status: 'Aktif',
  ...
  {
    OrderID: 16,
    CustomerName: 'Makanan Kura Kura',
    TotalAmount: 1285000,
    OrderItems: 'Candy Gucci',
    Location: 'Petshop Batam',
    Status: 'Aktif',
...
export const storeAddressOption =[
  {
...
export const accountTypeOption =[
  {
    Name: 'Pilih Type Akun',
    input: 'Pilih Type Akun'
  },
  {
    Name: 'User',
    input: 'user'
